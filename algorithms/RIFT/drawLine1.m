...
%     line([matchLoc1(i,1) matchLoc2(i,1)+disp],[matchLoc1(i,2) matchLoc2(i,2)], 'Color', [rand(),rand(),1.0]);
    line([matchLoc1(i,1) matchLoc2(i,1)+disp],[matchLoc1(i,2) matchLoc2(i,2)], 'Color','g');
%     plot(matchLoc1(i,1),matchLoc1(i,2),'g*');
%     plot(matchLoc2(i,1)+disp,matchLoc2(i,2),'g*');
%     plot(matchLoc1(i,1),matchLoc1(i,2),     'o','MarkerEdgeColor','g');
%     plot(matchLoc2(i,1)+disp,matchLoc2(i,2),'o','MarkerEdgeColor','g');
    plot(matchLoc1(i,1),matchLoc1(i,2),     'go');
    plot(matchLoc2(i,1)+disp,matchLoc2(i,2),'go');
end
hold off;
end